...
public class REQ03CT03EditarAlunoSucessoTest {
	...
	@Test
	public void rEQ03CT03EditarAlunoSucesso() {
		...
		vars.put("win9801", waitForWindow(2000));
		driver.switchTo().window(vars.get("win9801").toString());
